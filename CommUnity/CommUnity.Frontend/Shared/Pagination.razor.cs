...
namespace CommUnity.FrontEnd.Shared
{
    public partial class Pagination
    {
        ...
        private int StartPage => Math.Max(1, CurrentPage - Radio / 2);
        private int EndPage => Math.Min(TotalPages, StartPage + Radio - 1);
