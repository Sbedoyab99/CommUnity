...
namespace CommUnity.BackEnd.Controllers
{
    ...
    public class ResidentialUnitsController : GenericController<ResidentialUnit>
    {
        private readonly IResidentialUnitUnitOfWork _residentialUnitUnitOfWork;

        public ResidentialUnitsController(IGenericUnitOfWork<ResidentialUnit> unitOfWork, IResidentialUnitUnitOfWork residentialUnitUnitOfWork) : base(unitOfWork)
        {
